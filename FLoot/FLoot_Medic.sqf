...
Parameters: [unitname]
_null = [unitname] execVM "\z\addons\dayz_server\addons\FLoot\FLoot_Bandit.sqf";
*/
...
_itemslistMisc = ["ItemGoldBar","TrashJackDaniels","TrashJackDaniels","ItemGoldBar","TrashJackDaniels","TrashJackDaniels","ItemGoldBar","TrashJackDaniels","TrashJackDaniels","ItemGoldBar","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","TrashJackDaniels","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","ItemSodaEmpty","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","TrashTinCan","ItemSodaEmpty","ItemTrashRazor","ItemTrashToiletpaper","TrashJackDaniels","TrashTinCan","ItemTinBar","ItemCopperBar","ItemSilverBar","ItemGoldBar","ItemTent","ItemTentDomed","ItemTentDomed2","ItemTentOld","ItemCanvas"];
